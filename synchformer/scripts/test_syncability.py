...
from synchformer.model.modules.feat_extractors.train_clip_src.training.train import AverageMeter

from synchformer.scripts.train_utils import (broadcast_obj, calc_cls_metrics, gather_dict, get_batch_sizes,
...
from synchformer.utils.utils import cfg_sanity_check_and_patch
